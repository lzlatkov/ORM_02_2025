...
from main_app.choises import LaptopBrandChoices, OperationSystemChoices, MealTypeChoices, DungeonDifficultyChoices, WorkoutTypeChoices
...
class Laptop(models.Model):
    ...
    operation_system = models.CharField(
        max_length=20,
        choices=OperationSystemChoices
    )
