# Generated by Django 5.0.4 on 2025-03-29 08:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('co_authors', models.ManyToManyField(blank=True, related_name='coauthored_books', to='main_app.author')),
                ('main_author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='main_books', to='main_app.author')),
