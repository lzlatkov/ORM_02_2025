# Generated by Django 5.0.4 on 2025-03-29 07:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('Fiction', 'Fiction'), ('Non-Fiction', 'Nonfiction'), ('Other', 'Other')], default='Other', max_length=11)),
                ...
                ('main_author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='main_author_books', to='main_app.author')),
